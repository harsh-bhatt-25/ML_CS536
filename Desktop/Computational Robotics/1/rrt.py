...
#         samples = sample()
#
#         if isCollisionFree(t.robot, samples, t.obstacles) and not t.exists(samples):
...
def rrt(robot, obstacles, start, goal, iter_n):
    ...
    for i in range(0, iter_n):
        ...
        if isCollisionFree(tree.robot, point2, tree.obstacles):
...
if __name__ == "__main__":
    ...
    rrt(robot1, obstacles1, problems1[0][0], problems1[0][1], 500)
